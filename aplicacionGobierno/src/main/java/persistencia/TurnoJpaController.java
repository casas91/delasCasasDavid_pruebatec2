...
public class TurnoJpaController implements Serializable {
    ...
    public TurnoJpaController() {
        emf = Persistence.createEntityManagerFactory("aplicacionGobiernoPU");
    }
    ...
    public void create(Turno turno) {
        ...
        try {
            ...
            if (unCiudadano != null) {
                unCiudadano = em.getReference(unCiudadano.getClass(), unCiudadano.getId());
    ...
    public void edit(Turno turno) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (unCiudadanoNew != null) {
                unCiudadanoNew = em.getReference(unCiudadanoNew.getClass(), unCiudadanoNew.getId());
